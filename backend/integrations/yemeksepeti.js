...
class YemeksepetiIntegration {
  ...
  async getProducts() {
    try {
      ...
      return [
        { id: '1', name: 'Sucuklu Pizza', price: 48.00, category: 'pizza', available: true },
        { id: '2', name: 'Mega Burger', price: 38.00, category: 'burger', available: true },
        { id: '3', name: 'İskender Kebap', price: 65.00, category: 'kebap', available: true },
        { id: '4', name: 'Et Döner', price: 42.00, category: 'doner', available: true },
        { id: '5', name: 'Garden Salata', price: 22.00, category: 'salata', available: true }
      ];
    } catch (error) {
      console.error('Yemeksepeti products fetch error:', error.message);
      return [];
    }
  }
}
