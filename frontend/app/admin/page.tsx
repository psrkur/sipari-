        ...
        <div className="bg-white shadow-sm border-b px-6 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-gray-900">
              ...
              {activePage === 'whatsapp' && '💬 WhatsApp Yönetimi'}
            </h1>
              ...
              {activePage === 'whatsapp' && (
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                      <div className="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-green-800">WhatsApp Aktif</h3>
                          <p className="text-sm text-green-600">Müşteriler ile iletişim kurulabilir</p>
                        </div>
                      </div>
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          <span className="text-green-700">Telefon:</span>
                          <span className="font-medium">+90 555 123 45 67</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-green-700">Mesaj:</span>
                          <span className="font-medium">Merhaba! Sipariş vermek istiyorum.</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                      <div className="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-blue-800">İstatistikler</h3>
                          <p className="text-sm text-blue-600">Son 30 gün</p>
                        </div>
                      </div>
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          <span className="text-blue-700">Toplam Tıklama:</span>
                          <span className="font-medium">1,247</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-blue-700">Başarılı İletişim:</span>
                          <span className="font-medium">89%</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-blue-700">Ortalama Yanıt:</span>
                          <span className="font-medium">2.3 dk</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
                      <div className="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-purple-800">Hızlı Mesajlar</h3>
                          <p className="text-sm text-purple-600">Önceden tanımlanmış</p>
                        </div>
                      </div>
                      <div className="space-y-2">
                        <div className="text-sm text-purple-700">
                          <span className="font-medium">1.</span> "Merhaba! Sipariş vermek istiyorum."
                        </div>
                        <div className="text-sm text-purple-700">
                          <span className="font-medium">2.</span> "Menü hakkında bilgi alabilir miyim?"
                        </div>
                        <div className="text-sm text-purple-700">
                          <span className="font-medium">3.</span> "Teslimat süresi ne kadar?"
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-8 text-center">
                    <a
                      href="https://wa.me/905551234567?text=Merhaba! Sipariş vermek istiyorum."
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center space-x-2 px-6 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-all duration-200 hover:shadow-md"
                    >
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.865 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0020.885 3.488"/>
                      </svg>
                      <span>WhatsApp'ta Test Et</span>
                    </a>
                  </div>
                </div>
              )}
